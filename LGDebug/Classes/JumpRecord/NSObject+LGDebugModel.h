 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `LGDebugModel` protocol for custom methods.
 
 
 Sample Code:
 
 ********************** json convertor *********************
 @interface LGDebugAuthor : NSObject
 @property (nonatomic, strong) NSString *name;
 @property (nonatomic, assign) NSDate *birthday;
 @end
 @implementation LGDebugAuthor
 @end
 
 @interface LGDebugBook : NSObject
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) NSUInteger pages;
 @property (nonatomic, strong) LGDebugAuthor *author;
 @end
 @implementation LGDebugBook
 @end
 
 int main() {
 // create model from json
 LGDebugBook *book = [LGDebugBook LGDebug_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
 // convert model to json
 NSString *json = [book LGDebug_modelToJSONString];
 // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
 }
 
 ********************** Coding/Copying/hash/equal *********************
 @interface LGDebugShadow :NSObject <NSCoding, NSCopying>
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) CGSize size;
 @end
 
 @implementation LGDebugShadow
 - (void)encodeWithCoder:(NSCoder *)aCoder { [self LGDebug_modelEncodeWithCoder:aCoder]; }
 - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self LGDebug_modelInitWithCoder:aDecoder]; }
 - (id)copyWithZone:(NSZone *)zone { return [self LGDebug_modelCopy]; }
 - (NSUInteger)hash { return [self LGDebug_modelHash]; }
 - (BOOL)isEqual:(id)object { return [self LGDebug_modelIsEqual:object]; }
 @end
 
 */
@interface NSObject (LGDebugModel)
 ...
 */
+ (nullable instancetype)LGDebug_modelWithJSON:(id)json;
...
/**
 ...
 `NSString` -> NSDate, parsed with format "LGDebugLGDebug-MM-dd'T'HH:mm:ssZ", "LGDebugLGDebug-MM-dd HH:mm:ss" or "LGDebugLGDebug-MM-dd".
 `NSString` -> NSURL.
 `NSValue` -> struct or union, such as CGRect, CGSize, ...
 `NSString` -> SEL, Class.
 */
+ (nullable instancetype)LGDebug_modelWithDictionary:(NSDictionary *)dictionary;
...
/**
 ...
 See [NSJSONSerialization isValiLGSONObject] for more information.
 ...
 */
- (nullable id)LGDebug_modelToJSONObject;
 ...
 */
- (nullable NSData *)LGDebug_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)LGDebug_modelToJSONString;
 ...
 */
@interface NSArray (LGDebugModel)
 ...
 */
+ (nullable NSArray *)LGDebug_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (LGDebugModel)
 ...
 */
+ (nullable NSDictionary *)LGDebug_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<LGDebugModel>' to your class header.
 */
@protocol LGDebugModel <NSObject>
@optional
...
/**
 ...
 Example:
 @class LGDebugShadow, LGDebugBorder, LGDebugAttachment;
 
 @interface LGDebugAttributes
 @property NSString *name;
 ...
 @implementation LGDebugAttributes
 + (NSDictionary *)modelContainerPropertyGenericClass {
 return @{@"shadows" : [LGDebugShadow class],
 @"borders" : LGDebugBorder.class,
 @"attachments" : @"LGDebugAttachment" };
 }
 @end
...
/**
 ...
 Example:
 @class LGDebugCircle, LGDebugRectangle, LGDebugLine;
 
 @implementation LGDebugShape
 
 + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
 if (dictionary[@"radius"] != nil) {
 return [LGDebugCircle class];
 } else if (dictionary[@"width"] != nil) {
 return [LGDebugRectangle class];
 } else if (dictionary[@"y2"] != nil) {
 return [LGDebugLine class];
 } else {
 return [self class];
 }
 }
