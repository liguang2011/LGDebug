...
- (void)viewDidLoad {
    ...
    LGDebugNotificationManager *notiManager = [LGDebugNotificationManager shareManager];
//    IASKSettingsStoreUserDefaults *udSettingsStore = (id)self.settingsStore;
    [notiManager addObserver:self selector:@selector(userDefaultsDidChange) name:NSUserDefaultsDidChangeNotification];
    [notiManager addObserver:self selector:@selector(didChangeSettingViaIASK:) name:kIASKAppSettingChanged];
    [notiManager addObserver:self selector:@selector(synchronizeSettings) name:UIApplicationDidEnterBackgroundNotification];
    [notiManager addObserver:self selector:@selector(reload) name:UIApplicationWillEnterForegroundNotification];
    [notiManager addObserver:self selector:@selector(synchronizeSettings) name:UIApplicationWillTerminateNotification];
}
